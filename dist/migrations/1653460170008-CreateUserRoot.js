...
class CreateUserRoot1653460170008 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`INSERT INTO users(name,lastname,email,password,"roleId") 
        VALUES('User','Root','${process.env.USER_ROOT_EMAIL}','${process.env.USER_ROOT_PASSWORD}',1);`);
        });
    }
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
